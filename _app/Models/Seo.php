...
class Seo {
     ...
     private function getSeo() {
          ...
          switch ($this->File):
               ...
               //SEO:: INDEX
               case 'index':
                    $this->Data = [SITENAME . ' - Sistema de gerenciamento Financeiro', SITEDESC, HOME, INCLUDE_PATH . '/images/site.png'];
                    break;
     ...
     private function setTags() {
          ...
          $this->Tags['Link'] = "http://" . $server . $endereco;

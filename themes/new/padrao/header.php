<nav class="lighten-1 header_color" role="navigation">
    <div class="nav-wrapper logo"><a id="logo-container" href="<?= HOME ?>" class="brand-logo">EcoLights</a>
        <ul class="right hide-on-med-and-down">
            ...
            <li><a href="<?= HOME ?>/sobre/time" title="Nosso time">Ranking da Economia<span class="new badge"></span></a></li>
<!--            <li><a href="#" title="Como Calcular">Como Calcular<span class="new badge">Em Breve!</span></a></li>-->
            ...
            <a class='waves-effect waves-light btn btn_login dropdown-button btn' href='#' data-activates='dropdown1'>Drop Me!</a>
        </ul>
